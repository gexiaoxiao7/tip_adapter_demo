...
def classes(config):
    classes_all = pd.read_csv(config['labels_file'])
...
def main():
    ...
    train_loader_cache, val_loader, test_loader, train_loader_F = build_dataloader(cfg)
    class_names = [class_name for i, class_name in classes(cfg)]
    # Textual features
    print("\nGetting textual features as CLIP's classifier.")
    clip_weights = clip_classifier(class_names, cfg['template'], clip_model)
